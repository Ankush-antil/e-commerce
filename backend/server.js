...
const { addProduct, listProducts, getProductById, getProductReviews, addReview, deleteReview, removeProduct } = require("./controller/productcontrol")
...
app.delete("/product/:productId/review/:reviewId", authAdmin, deleteReview)
