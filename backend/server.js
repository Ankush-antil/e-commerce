...
const { addProduct, listProducts, getProductById, getProductReviews, addReview, deleteReview, seedDemoReviews, removeProduct } = require("./controller/productcontrol")
...
app.delete("/product/:productId/review/:reviewId", authUser, deleteReview)
